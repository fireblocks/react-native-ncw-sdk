import type { IJoinWalletEvent, IKeyBackupEvent, IKeyDescriptorChangedEvent, IKeyRecoveryEvent, IKeyTakeoverChangedEvent, ITransactionSignatureChangedEvent } from "./interfaces";
...
type TJoinWalletStatusApprover = TBaseStatus | "PROVISION_INITIATED" | "PROVISION_ADD_DEVICE_SETUP_REQUESTED" | "PROVISION_KEYS_SETUP_STARTED" | "PROVISION_SETUP_STARTED" | "PROVISION_SETUP_COMPLETED";
...
export type TEvent = IKeyDescriptorChangedEvent | IKeyTakeoverChangedEvent | ITransactionSignatureChangedEvent | IKeyBackupEvent | IKeyRecoveryEvent | IJoinWalletEvent;
