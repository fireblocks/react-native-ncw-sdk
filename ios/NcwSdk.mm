...
#import "RNNcwSdkSpec.h"
@interface RCT_EXTERN_MODULE(NcwSdk, NSObject<NativeNcwSdkSpec>)
#else
@interface RCT_EXTERN_MODULE(NcwSdk, NSObject<RCTBridgeModule>)
#endif
...
{
    return std::make_shared<facebook::react::NativeNcwSdkSpecJSI>(params);
}
#endif
