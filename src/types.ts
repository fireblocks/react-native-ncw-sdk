...
export type TJoinWalletStatus =
  | TJoinWalletStatusJoiner
  | TJoinWalletStatusApprover
  | 'STOPPED';

export type TKeyTakeoverStatus =
  | TBaseStatus
  | 'INITIATED'
...
export type TTransactionSignatureStatus =
  | TBaseStatus
  | 'PENDING'
  | 'STARTED'
  | 'COMPLETED';
